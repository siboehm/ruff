...
pub struct Options {
    ...
    /// The maximum [display width](http://www.unicode.org/reports/tr11/#Overview) of each line when
    /// formatting code and when enforcing long-lines violations (like
    /// `E501`).
    ///
    /// Must be greater than `0` and less than or equal to `320`.
    ...
    #[deprecated(
        since = "0.1.1",
        note = "The `line-width` option has been renamed to `line-width` to emphasize that the limit is the line's display width rather than the number of characters. Use `line-width = <value>` instead."
    )]
...
pub struct PycodestyleOptions {
    ...
    #[deprecated(
        since = "0.1.1",
        note = "The `max-doc-length` option has been renamed to `max-doc-width` to emphasize that the limit is the line's display width rather than the number of characters. Use `max-doc-width = <value>` instead."
    )]
    ...
    pub fn into_settings(self, global_line_width: LineWidth) -> pycodestyle::settings::Settings {
        ...
        let max_doc_width = {
            if self.max_doc_length.is_some() {
                warn_user_once!("The option `pycodestyle.max-doc-length` has been renamed to `pycodestyle.max-doc-width` to emphasize that the limit is the display width of a line and not the number of characters. Use `pycodestyle.max-doc-width` instead.");
            }
